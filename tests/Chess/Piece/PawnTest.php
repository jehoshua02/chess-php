...
class PawnTest extends \PHPUnit_Framework_TestCase
{
    public function testUp()
    {
        ...
        $this->assertFalse($board->getPiece('A2')->up(3), 'Pawn cannot move three up');
    }
    ...
    public function testDownLeft()
    {
        ...
        $this->assertFalse($board->getPiece('D5')->downLeft(), 'Pawn should not be able to move down and left');
        ...
        $this->assertFalse($board->getPiece('D5')->downLeft(), 'Light pawn should not be able to move down and left');
    }
    ...
    public function testDownRight()
    {
        ...
        $this->assertFalse($board->getPiece('H4')->downRight(), 'Pawn should not be able to move off edge of board');

        $board = new Board(array(
            'D5' => new Pawn(Piece::LIGHT),
            'E4' => new Pawn(Piece::DARK)
        ));
        $this->assertFalse($board->getPiece('D5')->downRight(), 'Light pawn should not be able to move down and right');
    }
}
